...
namespace CommonPostingLibrary
{
    public class LookupField
    {
        ...
        public string strDBFieldName
        {
            get
            {
                return _strDBFieldName;
            }
            set
            {
                _strDBFieldName = value;
            }
        }
        ...
        public string strHeaderName
        {
            get
            {
                return _strHeaderName;
            }
            set
            {
                _strHeaderName = value;
            }
        }
        ...
        public bool bIsReturnable
        {
            get
            {
                return _bIsReturnable;
            }
            set
            {
                _bIsReturnable = value;
            }
        }
        ...
        public LookupField(string fieldName)
            : this(fieldName, false)
        {
        }

        public LookupField(string fieldName, bool isReturnable)
            : this(fieldName, fieldName, isReturnable)
        {
        }

        public LookupField(string fieldName, string headerName, bool isReturnable)
            : this(fieldName, headerName, isReturnable, false)
        {
        }
