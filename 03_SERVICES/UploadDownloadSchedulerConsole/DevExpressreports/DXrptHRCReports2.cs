...
namespace UploadDownloadSchedulerConsole.DevExpressreports
{
    public partial class DXrptHRCReports2 : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        private HRCReportsBL hrcReportsBL = new HRCReportsBL();
        ...
        public DXrptHRCReports2()
        {
            InitializeComponent();
        }

        //Displaying only header and details
        public DXrptHRCReports2(string reportname, DataSet dsheader, DataSet ds, int[] margs, Font reportFont, DataSet dsSig, bool reptype)
        {
            InitializeComponent();
            this.DataSource = ds;
        ...
        public DXrptHRCReports2(string reportname, DataSet dsheader, DataSet ds, int[] margs, Font reportFont, DataSet dsSig, bool groupbyprof, bool groupbycost, string orderby, string[] cols, bool sortAsc)
        {
            InitializeComponent();
            dsSource2 = ds.Copy();
            if (groupbycost)
        ...
        public DXrptHRCReports2(string reportname, DataSet dsheader, DataSet ds, int[] margs, Font reportFont, DataSet dsSig, bool reptype, bool sortType, bool displaycoltotal, bool groupCost)
        {
            InitializeComponent();
            dsSource2 = ds.Copy();
            //Group by profiles
        ...
        private void initializeHeader()
        {
            ...
            {
                compName.Text = string.Empty;
                compAdd.Text = string.Empty;
                compTel.Text = string.Empty;
                compAdd.WidthF = compName.WidthF = compTel.WidthF = 750;
            }
