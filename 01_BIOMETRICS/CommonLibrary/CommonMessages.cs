...
namespace CommonLibrary
{
    ...
    {
        public static string ErrorList(string recordName)
        {

            return String.Format("Lot number {0} contain error status!.", recordName);
        ...
        //Fulbert 20070611 inserted in behalf of Seldon
        ...
        //start - carlo added fgendorsed 04-02-2007
        ...
        {
            return string.Format("The {0} is already existed.", Fieldname);
        }        
