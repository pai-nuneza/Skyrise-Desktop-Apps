...
namespace Payroll.CFC
{
	...
	[ToolboxBitmap(typeof(ColorProgressBar))]
	...
	{	
		...
		protected override void OnPaint(System.Windows.Forms.PaintEventArgs e)
		{
			...
			//
            float fillWidth = (this.Width * _Value) / (_Maximum - _Minimum);
			...
			//
			RectangleF topRect = new RectangleF(0, 0, fillWidth, this.Height / 2);
			RectangleF buttomRect = new RectangleF(0, this.Height / 2, fillWidth, this.Height / 2);
