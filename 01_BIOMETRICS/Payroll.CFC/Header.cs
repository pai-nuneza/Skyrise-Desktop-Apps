	...
	public class Header : IDisposable
	{
		...
		internal void MouseMove(Point mouseLocation)
		{
			...
			if (m_monthSelector)
			{
                ...
                else m_nextBtnState = mcButtonState.Hot; 
			...
			if (m_yearSelector)
			{
                ...
                else m_prevYearBtnState = mcButtonState.Hot;
                ...
                else m_nextYearBtnState = mcButtonState.Hot;
		...
		private Bitmap GetEmbeddedImage(string name)
		{
			...
			Stream myStream = myAssembly.GetManifestResourceStream("Payroll.CFC.Images."+name);
